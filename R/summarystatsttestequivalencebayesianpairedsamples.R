...
SummaryStatsTTestEquivalenceBayesianPairedSamples <- function(jaspResults, dataset = NULL, options, ...) {
  ...
  options <- .processInputTypeOptionsEquivalence(options, "pairedSamples")
  ...
  sd_val <- .getEquivalenceSd(options, "pairedSamples")
  ...
  # Compute and display
  results <- .summaryStatsEquivalenceTTestMainFunction(jaspResults, options, "pairedSamples")
  .summaryStatsEquivalencePriorPosteriorPlot(jaspResults, results, options, "pairedSamples")
  .summaryStatsEquivalenceMassTable(jaspResults, results, options, "pairedSamples")
